...
-- Use OSC 52 for clipboard over SSH (sends yanked text to local terminal clipboard)
vim.g.clipboard = {
  name = 'OSC 52',
  copy = {
...
-- Disable synchronized terminal output to fix vsplit scroll rendering glitch in WezTerm
...
require('lazy').setup({
    ...
    config = function(_, opts)
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Execute a code action, usually your cursor needs to be on top of an errortpope
  ...
  require 'kickstart.plugins.debug', -- adds DAP debugging support
